...
<main class="container">
    ...
    <div class="tabs-container">
        <button class="tab-button active" onclick="openTab(event, 'view-tab')">View Payments</button>
        <button class="tab-button" onclick="openTab(event, 'add-tab')">Record New Payment</button>
        <button class="tab-button" onclick="openTab(event, 'delete-tab')">Delete Payment</button>
    </div>
        ...
        <div class="form-section">
            ...
            <?php
                ...
                if ($result === FALSE) {
                    ...
                    echo '<div class="no-data">No payments found in the system</div>';
                }
            ?>
        </div>
    </section>
    ...
    <section id="delete-tab" class="tab-content">
        <div class="form-section">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <div class="form-group">
                    <label for="payment_id">Payment ID: <span style="color: red;">*</span></label>
