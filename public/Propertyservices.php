...
<head>
    ...
    <title>Property Services Management</title>
...
<main class="container">
    ...
    <div class="tabs-container">
        <button class="tab-button active" onclick="openTab(event, 'view-tab')">View Mappings</button>
        <button class="tab-button" onclick="openTab(event, 'add-tab')">Add Service Link</button>
        <button class="tab-button" onclick="openTab(event, 'delete-tab')">Delete Mapping</button>
    </div>
        ...
        <div class="form-section">
            ...
            <?php
                ...
                if ($result === FALSE) {
                    ...
                    echo '<div class="no-data">No property service mappings found in the system</div>';
                }
            ?>
        </div>
    </section>
    ...
    <section id="add-tab" class="tab-content">
        <div class="form-section">
            <h2>Add a Property Service Link</h2>
    ...
    <section id="delete-tab" class="tab-content">
        <div class="form-section">
            <h2>Delete Property Service Mapping</h2>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <div class="form-group">
                    <label for="propertyservice_id">Property Service ID: <span style="color: red;">*</span></label>
                    <input type="number" id="propertyservice_id" name="propertyservice_id" required>
                </div>
